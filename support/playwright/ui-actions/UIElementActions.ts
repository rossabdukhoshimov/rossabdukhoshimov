...
export default class UIElementActions {
  ...
  public async waitTillInvisible() {
    ...
    await this.getLocator().waitFor({ state: "hidden", timeout: 30000 });
    return this;
  }
  ...
  public async waitTillDetached() {
    ...
    await this.getLocator().waitFor({ state: "detached", timeout: 30000 });
    return this;
  }
  ...
  public async waitTillVisible() {
    ...
    await this.getLocator().waitFor({ state: "visible", timeout: 30000 });
    return this;
  }
  ...
  public async waitForPresent() {
    ...
    await this.getLocator().waitFor({ state: "attached", timeout: 30000 });
    return this;
  }
